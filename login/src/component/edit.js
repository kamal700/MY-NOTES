...
class Edit extends Component {
    ...
    clear = ()=>{
        document.getElementById('title' + this.props.id).innerText = "";
        document.getElementById('description' + this.props.id).innerText = ""
    }
                ...
                <div className="modal-dialog modal-lg" >
                    <div className="modal-content col-12 bg-dark text-light">
                            ...
                            <form id="dataForm">
                                <div className='container'>
                                    <div className='row mb-3'>
                                        ...
                                        <textarea className='m-1' name='title' id={'title' + this.props.id} rows={5} />
                                    </div>
                        ...
                        <div className="modal-footer">
                            <button type="button" className="btn btn-secondary" data-bs-dismiss="modal" onClick={()=>this.clear()}>Close</button>
